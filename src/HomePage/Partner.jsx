const Partner = () => {
  return (
    <div>
      <div className="max-w-5xl mx-auto px-5 lg:px-0 mt-section">
        <p className="text-slate-500 text-lg sm:text-xl pb-paragraph">
          What Helps Make a Great Retirement Plan?
        </p>
        <h1 className="font-semibold text-3xl md:text-5xl sm:text-4xl pb-paragraph">
